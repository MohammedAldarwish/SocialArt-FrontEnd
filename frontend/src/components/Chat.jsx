...
const Chat = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Chat Header */}
      <div className="bg-white border-b border-gray-200 px-4 py-4 flex items-center justify-between fixed top-0 md:top-16 left-0 right-0 z-40">
        ...
        <div className="flex items-center space-x-2">
          <button className="p-2 text-gray-600 hover:text-purple-600 transition-colors rounded-full hover:bg-purple-50">
      ...
      {/* Messages Area */}
      <div className="flex-1 overflow-y-auto px-4 py-4 mt-20 md:mt-24 mb-20">
      ...
      {/* Message Input */}
      <div className="bg-white border-t border-gray-200 px-4 py-4 fixed bottom-0 md:bottom-0 left-0 right-0 z-40">
          ...
          <form onSubmit={handleSendMessage} className="flex items-center space-x-3">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 py-3 bg-gray-100 rounded-2xl border-0 focus:bg-white focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all pr-12"
              />
