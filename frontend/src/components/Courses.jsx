  ...
  const courses = [
    {
      ...
      instructorAvatar: "https://images.pexels.com/photos/32718227/pexels-photo-32718227.jpeg",
      ...
      rating: 4.9,
      price: 89,
      description: "Master the art of watercolor painting with techniques used by professional artists.",
      lessons: 24,
      featured: true
    },
    {
      ...
      instructorAvatar: "https://images.unsplash.com/photo-1625682103688-2ab73a4fb11a",
      ...
      rating: 4.8,
      price: 79,
      description: "Unleash your creativity through abstract painting techniques and color theory.",
      lessons: 18,
      featured: true
    },
    {
      ...
      instructorAvatar: "https://images.unsplash.com/photo-1695927521717-a0ad39d93505",
      thumbnail: "https://images.unsplash.com/flagged/photo-1572392640988-ba48d1a74457",
      category: 'drawing',
      level: 'Advanced',
      duration: '12 hours',
      students: 567,
      rating: 4.9,
      price: 129,
      description: "Learn time-tested drawing techniques from Renaissance masters.",
      lessons: 32,
      featured: false
    },
    {
      ...
      instructorAvatar: "https://images.pexels.com/photos/32721688/pexels-photo-32721688.jpeg",
      thumbnail: "https://images.pexels.com/photos/1573434/pexels-photo-1573434.jpeg",
      category: 'digital',
      level: 'Beginner',
      duration: '10 hours',
      students: 2156,
      rating: 4.7,
      price: 99,
      description: "Start your digital art journey with industry-standard tools and techniques.",
      lessons: 28,
      featured: true
    },
    {
      ...
      instructorAvatar: "https://images.unsplash.com/photo-1539135950877-26943cd58152",
      ...
      rating: 4.8,
      price: 109,
      description: "Create stunning portraits with advanced shading and proportion techniques.",
      lessons: 22,
      featured: false
    },
    {
      ...
      instructorAvatar: "https://images.unsplash.com/photo-1745165549821-7382d2e740d4",
      ...
      rating: 4.6,
      price: 85,
      description: "Capture the beauty and power of the sea through traditional painting methods.",
      lessons: 20,
      featured: false
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Learn from the 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600"> Best</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Master new art techniques with courses taught by professional artists and industry experts
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all shadow-sm"
            />
          </div>
        </div>
