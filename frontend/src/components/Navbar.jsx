  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link 
                to="/settings" 
                className={`flex items-center space-x-2 px-3 py-2 rounded-xl transition-all ${
                  isActive('/settings') ? 'bg-purple-100 text-purple-600' : 'text-gray-600 hover:text-purple-600'
                }`}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-100">
        ...
        <div className="grid grid-cols-3 gap-1 py-1 px-2 border-t border-gray-200">
          <Link 
            to="/notifications" 
          ...
          >
            ...
            <div className="absolute top-0 right-1 w-3 h-3 bg-pink-500 text-white text-xs rounded-full flex items-center justify-center">5</div>
          </Link>
          ...
          <Link 
            to="/upload" 
            className="flex flex-col items-center py-1 px-1 rounded-lg transition-all text-purple-600"
          >
            <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4"/>
            </svg>
