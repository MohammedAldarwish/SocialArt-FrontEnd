...
const Settings = () => {
  ...
  const tabs = [
    ...
    { id: 'appearance', name: 'Appearance', icon: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4 4 4 0 004-4V5z' },
    { id: 'support', name: 'Support', icon: 'M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' }
  ];
                      ...
                      <div key={key} className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-dark-600">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            {key === 'courses' && 'Get notified about new courses and updates'}
                            {key === 'marketing' && 'Receive emails about new features and promotions'}
                          </p>
                        </div>
                        <button
                          onClick={() => handleNotificationChange(key)}
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            value ? 'bg-gradient-to-r from-purple-600 to-pink-600' : 'bg-gray-200'
                          }`}
                        >
                          <span
                      ...
                      <div key={key} className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-dark-600">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            {key === 'showOnline' && 'Show when you are online to other users'}
                          </p>
                        </div>
                        <button
