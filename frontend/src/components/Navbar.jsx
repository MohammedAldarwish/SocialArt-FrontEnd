    ...
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-100">
        <div className="grid grid-cols-6 gap-1 py-2">
          ...
          <Link 
            to="/messages" 
            className={`flex flex-col items-center py-2 px-2 rounded-xl transition-all relative ${
          ...
          <Link 
            to="/upload" 
            className="bg-gradient-to-r from-purple-600 to-pink-600 p-3 rounded-full shadow-lg flex items-center justify-center mx-2"
          >
