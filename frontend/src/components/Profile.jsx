            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-10">
              ...
              <div className="flex-1 text-center lg:text-left w-full">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                  ...
                  <button
                    onClick={() => navigate('/settings')}
                    className="bg-white dark:bg-dark-700 border border-gray-200 dark:border-dark-600 text-gray-700 dark:text-gray-300 px-6 sm:px-7 md:px-8 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl font-medium hover:bg-gray-50 dark:hover:bg-dark-600 hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 md:hidden">
                    <svg
                      className="w-4 h-4 sm:w-5 sm:h-5"
                      fill="none"
                      stroke="currentColor"
